...
-(void)update {
  ...
  NSArray *parameters = [[self propertyValues] arrayByAddingObject:[NSNumber numberWithUnsignedLong:primaryKey]];
...
-(void)deleteSelf {
  ...
  [database executeSqlWithParameters:sql, [NSNumber numberWithUnsignedLong:primaryKey], nil];
  savedInDatabase = NO;
  primaryKey = 0;
}
